...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
      ...
      if (geminiEnabled && apiKey) {
        ...
        if (respAi.ok) {
          ...
          try {
            ...
            } as { title: string; description: string; price: string; mainImage: string; images: string[] };
    ...
    const msg = typeof (e as Error)?.message === "string" ? (e as Error).message : "Erreur inconnue";
